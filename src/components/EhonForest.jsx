  ...
  return (
    <div style={{minHeight:"100vh",background:"#fdf8ef",fontFamily:"'Zen Maru Gothic','Hiragino Maru Gothic Pro',sans-serif",color:"#3d5c46"}}>
      ...
      <footer style={{textAlign:"center",padding:"40px 24px",background:"rgba(255,255,255,0.5)",borderTop:"2px solid #e4f0e4",position:"relative",zIndex:10}}>
        ...
        <a href="https://apple.ehonnomori-studio.com" target="_blank" rel="noopener noreferrer" style={{display:"inline-block",margin:"12px auto 0",padding:"8px 20px",background:"linear-gradient(135deg,#a8d5a2,#6daa7a)",color:"white",borderRadius:20,fontSize:13,fontWeight:700,textDecoration:"none",fontFamily:"inherit",boxShadow:"0 2px 8px rgba(109,170,122,0.3)"}}>
          🍏 アップルちゃんのサイトへ
        </a>
